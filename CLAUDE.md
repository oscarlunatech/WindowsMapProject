...
**Done: phases 1–9. Next: Phase 10 (display CRS).**
...
| **10** | **Display CRS** — user-selectable, on-the-fly reprojection, Web Mercator default. Revisits Phase 6 (see constraints below) | next |
